...
public class AmazonECSObject {
	...
	public AmazonECSObject(String _version, String _accessKeyId,
			String serviceName, String _operation, String _resGroup,
			String _itemId, String _contentType, String _searString,
			String _idString) {
		version = _version;
	...
	public Map<String, String> generateRequestMap() {
		...
		if (version != null)
			map.put(ECS_VERSION, version);
		if (serviceName != null)
			map.put(ECS_SERVICE, serviceName);
		if (operation != null)
			map.put(ECS_OPERATION, operation);
		if (resGroup != null)
			map.put(ECS_RESGROUP, resGroup);
		if (itemId != null)
			map.put(ECS_ITEMID, itemId);
		if (contentType != null)
			map.put(ECS_CONTENTTYPE, contentType);
		if (searchIndex != null)
			map.put(ECS_SEARCHINDEX, searchIndex);
		if (idType != null)
			map.put(ECS_IDTYPE, idType);
		return map;
	}
