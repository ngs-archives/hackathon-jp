	...
	public void handleMessage(Message message) {
		...
		case R.id.decode_failed:
			...
			CameraManager.get().requestPreviewFrame(mDecodeThread.mHandler,
					R.id.decode);
			/*
			 * Bundle bundle = message.getData(); Bitmap barcode =
			 * bundle.getParcelable(DecodeThread.BARCODE_BITMAP); int duration =
			 * message.arg1; mActivity.handleDecode((Result) message.obj,
			 * barcode, duration);
			 */
			break;
