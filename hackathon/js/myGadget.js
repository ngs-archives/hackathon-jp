...
function addCheck(key)
{
	...
	if ( document.getElementById("re_"+key) == undefined )
	{
		...
		re.src = "http://devel.nissan-carwings.com/test-cgi/test/igoogle/reten.gif";
...
function printProfileScreen(data) 
{
	...
	viewerobj = 
		{"name":fname+" "+gname, "gender":gender, "id":id, "address": address};
	showProf();
...
function getCarwings()
{
	...
	var url = 
		"http://devel.nissan-carwings.com/test-cgi/test/igoogle/auth.cgi" +
...
function response(obj)
{
	...
	if ( j.token != undefined && j.token != "null" && j.token != null )
	{
		...
		*/
		...
		// Carwingsを友達として追加する。
		var icon = "http://devel.nissan-carwings.com/test-cgi/test/igoogle/icon.png";
...
//objectdump(o, document.getElementById("dumpArea"));
	...
	{
		photo.src = 
				//"http://devel.nissan-carwings.com/test-cgi/test/igoogle/small.png";
				"http://devel.nissan-carwings.com/test-cgi/test/igoogle/noimg-1_1.gif";
	}
	else
	{
		photo.src = o.img;
...
function loadData(id, token)
{
	var date = new Date().getTime();
	var url = 
		"http://devel.nissan-carwings.com/test-cgi/test/igoogle/read.cgi"+
		"?cachebuster=" + date + "&token="+ token + "&id="+ viewerobj.id;
...
/*
	...
	var url = "http://devel.nissan-carwings.com/test-cgi/test/igoogle/save.cgi";
	var param = 
	{
		json : j,
		cachebuster : date,
