...
public class AmazonECSService {
	...
	public AmazonECSService(String version, String accessKeyId,
	...
	public String search(String _version, String _operation, String _resGroup,
			String _itemId, String _contentType, String _searchString,
			String _idString) throws ParserConfigurationException,
			SAXException, IOException {
		AmazonECSObject obj = new AmazonECSObject(_version, this.accessKeyId,
				null, _operation, _resGroup, _itemId, _contentType,
				_searchString, _idString);
	...
	public String searchByISBN(String isbn)
		...
		AmazonECSObject obj = new AmazonECSObject(this.version,
				this.accessKeyId, ECS_SERVICE_NAME, ITEMLOOKUP_OPERATION,
				DEFAULT_RESGROUP, isbn, CONTENT_TYPE, BOOKS_SEARCHINDEX,
				ISBN_IDTYPE);
		SignedRequestsHelper helper = new SignedRequestsHelper(
				this.accessKeyId, this.secretAccessKey);
		String reqStr = helper.sign(obj.generateRequestMap());
